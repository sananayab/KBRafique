    ...
    return (
        <header className="w-full h-auto bg-transparent overflow-x-hidden fixed z-50 top-0 left-0">
            <Slide direction="down">
                <nav className={`w-full md:h-24 h-20 ${navBarColor ? "bg-white" : "bg-transparent"} lg:px-24 md:px-12 px-8 flex justify-between items-left`}>
                    <Image as="a" href="/" className="md:h-15 h-15" image={Logo} alt="Logo" />
                        ...
                        <ul className="flex items-center justify-center gap-6">
                            ...
                            <List className="text-gray-950">
                                <select className="border-none font-light text-base outline-none bg-transparent">
                                    <option value="EN" selected>Country</option>
                                    <option value="ITA">UK</option>
                                    <option value="FRA">USA</option>
                                    <option value="ITA">KSA</option>
                                    <option value="FRA">UAE</option>
                                </select>
                            </List>
                        </ul>
                    </div>
